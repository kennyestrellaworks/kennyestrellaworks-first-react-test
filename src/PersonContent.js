            ...
            <div className="profile-card">
              <div className="profile-card__profile">
                <img
                  src={imageURL}
                  alt={fullName}
                  className="profile-card__profile-picture"
                />
                <h1 className="heading-style-2 heading-style-2__primary profile-card__person-name">
                  {fullName}
                </h1>
                <h2 className="heading-style-2 heading-style-2__secondary profile-card__person-position">
                  {job_position}
                </h2>
                <div
                  className="profile-card__profile-social"
                  data-id={id}
                ></div>
              </div>
            </div>
